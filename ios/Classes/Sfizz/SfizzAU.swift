...
public class SfizzAU: AUAudioUnit {
    ...
    public func loadSfzFile(path: String) -> Bool {
        return kernelAdapter.loadSfzFile(path)
    }
    
    public func loadSfzString(sampleRoot: String, sfzString: String) -> Bool {
        return kernelAdapter.loadSfzString(sampleRoot, sfzString: sfzString)
    }
